...
const Blog = () => {
  const blogPosts = [
    ...
    {
      id: 3,
      title: 'Lets keep Clean and tide',
      author: 'Owner',
  ...
  return (
    <div>
      ...
      <p className="blog-intro">Stay updated with the latest tips, trends, and insights in shop management and retail technology.</p>
