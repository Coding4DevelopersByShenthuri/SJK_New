...
const Hero = () => {
  ...
  const heroSliderItems = [
    ...
    {
      imgSrc: '../src/assets/images/hero-slider-15.jpg',
    ...
    {
      imgSrc: '../src/assets/images/hero-slider-5.avif',
    ...
    {
      imgSrc: '../src/assets/images/hero-slider-14.jpg',
    ...
    {
      imgSrc: '../src/assets/images/hero-slider-17.jpg',
      subtitle: 'Local & Fresh',
    ...
    {
      imgSrc: '../src/assets/images/hero-slider-18.jpg',
      subtitle: 'Seasonal Favorites',
      title: 'Artistry on Every Plate',
      text: 'Supporting local farmers for a truly fresh experience',
      buttonText: 'Explore Pairings',
